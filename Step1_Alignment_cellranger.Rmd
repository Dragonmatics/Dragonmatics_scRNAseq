...
> 💡 **Pro Tip**: When working with large datasets (>10,000 cells), opt for the recommended specifications to ensure smooth processing.
...
> 💡 **Quick Tip**: Always double-check your file names before starting the analysis. A misnamed file can cause the entire pipeline to fail.
...
```csv
sample,fastq_path
11C1_BPN1,/path/to/your/rawdata
11C1_BPN2,/path/to/your/rawdata
11C1_VEH1,/path/to/your/rawdata
11C1_VEH2,/path/to/your/rawdata
FXS_BPN1,/path/to/your/rawdata
FXS_BPN2,/path/to/your/rawdata
FXS_VEH1,/path/to/your/rawdata
FXS_VEH2,/path/to/your/rawdata
```
<br>

# 🏃 💨 Running the Cell Ranger Pipeline
...
└── outs/
    ├── count/
    │   ├── analysis/                     # Secondary analysis results (clustering, t-SNE, etc.)
    │   ├── filtered_feature_bc_matrix/   # Filtered gene-barcode matrices in MEX format
    │   ├── cloupe.cloupe                 # Loupe Browser visualization file
    │   ├── feature_reference.csv         # Feature reference for the aggregated dataset
    │   ├── filtered_feature_bc_matrix.h5 # Filtered gene-barcode matrices in HDF5 format
    │   └── summary.json                  # Aggregation summary metrics
    ├── aggregation.csv                   # The input aggregation CSV
    └── web_summary.html                  # HTML summary of the run
```
