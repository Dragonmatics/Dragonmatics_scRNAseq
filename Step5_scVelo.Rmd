...
This comprehensive tutorial demonstrates the implementation of RNA velocity analysis using scVelo[@RN78], a state-of-the-art Python package for single-cell RNA sequencing (scRNA-seq) data analysis. Published in Nature Biotechnology (2020), scVelo represents a significant advancement in transcriptional dynamics analysis, building upon and enhancing the foundational RNA velocity framework while addressing limitations of its predecessor, velocyto.

RNA velocity[@RN80] analysis employs sophisticated mathematical modeling of transcriptional kinetics to unveil cellular dynamics that traditional scRNA-seq approaches cannot directly capture. This powerful methodology enables researchers to:
...
Our analysis begins with a curated mouse brain dataset encompassing both disease and control samples. The initial data processing pipeline, executed in R using the Seurat framework[@RN79], included:
...
pdf_convert(pdf = "figures/umap_annotated_celltypes.pdf",
  format = "png", pages = 1,
  filenames = "figures/umap_annotated_celltypes.png", dpi = 300)
```

<div class="figure" style="text-align: center">
<img src="figures/umap_annotated_celltypes.png" alt="umap_annotated_celltypes" style="width: 70%;"/>
...
## 🖼️ plot velocity of a selected gene
...
pdf_convert(pdf = "figures/scvelo_SLC17A6_stream.pdf",
  format = "png", pages = 1,
  filenames = "figures/scvelo_SLC17A6_stream.png", dpi = 300)
```
<div class="figure" style="text-align: center">
<img src="figures/scvelo_SLC17A6_stream.png" alt="scvelo_SLC17A6_stream" style="width: 70%;"/>
<p class="caption" style="text-align: center;"><b>Figure 6.</b> scvelo_SLC17A6_stream</p>
</div>
...
4. **Graph-based Topology**:
   - Implementation of partition-based graph abstraction (PAGA)[@RN83]
...
```{r, eval=FALSE, echo=FALSE}
pdf_convert(pdf = "figures/scvelo_excitatory_neurons_scatter.pdf",
  format = "png", pages = 1,
  filenames = "figures/scvelo_excitatory_neurons_scatter.png", dpi = 300)
```
<div class="figure" style="text-align: center">
<img src="figures/scvelo_excitatory_neurons_scatter.png" alt="excitatory_neurons_scatter" style="width: 70%;"/>
<p class="caption" style="text-align: center;"><b>Figure 7.</b> excitatory_neurons_scatter</p>
</div>
...
```
```{r, eval=FALSE, echo=FALSE}
pdf_convert(pdf = "figures/scvelo_radial_glia_scatter.pdf",
  format = "png", pages = 1,
  filenames = "figures/scvelo_radial_glia_scatter.png", dpi = 300)
```
<div class="figure" style="text-align: center">
<img src="figures/scvelo_radial_glia_scatter.png" alt="scvelo_radial_glia_scatter" style="width: 70%;"/>
<p class="caption" style="text-align: center;"><b>Figure 8.</b> scvelo_radial_glia_scatter</p>
</div>
...
```{python bugfix,  class.source="python", eval=FALSE}
...
3. **Future Directions**:
   - Integration with CellRank[@RN81] for enhanced fate mapping
