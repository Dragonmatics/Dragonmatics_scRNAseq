...
# hubgene network
png("figures/network_visualization/hub_net.png", width=1600, height=1600)
HubGeneNetworkPlot(
  seurat_obj,
  n_hubs = 3, n_other=5,
  edge_prop = 0.75,
...
png("figures/network_visualization/hub_net_custom.png", width=1600, height=1600)
...
# hubgene network
png("figures/network_visualization/hub_net_5mods.png", width=1600, height=1600)
HubGeneNetworkPlot(
  seurat_obj,
...
p <- ggplot(umap_df, aes(x=UMAP1, y=UMAP2)) +
  ...
  umap_theme()
ggsave("figures/network_visualization/hubgene_umap.png", p, width=6, height=6)
```
...
```{r eval=FALSE}
png("figures/network_visualization/hubgene_umap_igraph.png", width=1200, height=1200)
ModuleUMAPPlot(
  seurat_obj,
  edge.alpha=0.25,
  sample_edges=TRUE,
