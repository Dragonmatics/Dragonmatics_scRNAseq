...
reticulate::use_python("C:/Python313/python.exe", required=T)
...
<img src="figures/umap_annotated_celltypes.jpg" alt="umap_annotated_celltypes" style="width: 70%;"/>
...
```
<div class="figure" style="text-align: center">
<img src="figures/scvelo_Xkr4_stream.png" alt="scvelo_SLC17A6_stream" style="width: 70%;"/>
...
```
<div class="figure" style="text-align: center">
<img src="figures/scvelo_Ngn3 low EP_scatter.png" alt="excitatory_neurons_scatter" style="width: 70%;"/>
...
pdf_convert(pdf = "figures/scvelo_Ngn3 high EP_scatter.pdf",
  format = "png", pages = 1,
  filenames = "figures/scvelo_rNgn3 high EP_scatter.png", dpi = 300)
```
<div class="figure" style="text-align: center">
<img src="figures/scvelo_rNgn3 high EP_scatter.png" alt="scvelo_radial_glia_scatter" style="width: 70%;"/>
...
# Lineage-Specific Velocity Analysis
...
sc.pl.umap(adata_subset, color=['clusters'], frameon=False, title=['', ''])
...
scv.pl.scatter(adata_subset, color='clusters', basis=top_genes[:15], ncols=5, frameon=False)

var_names = ['MTUS2', 'PPFIA2', 'NMNAT2']
scv.pl.scatter(adata_subset, var_names, color='clusters', frameon=False)
scv.pl.scatter(adata_subset, x='latent_time', y=var_names, color='clusters', frameon=False)
```
